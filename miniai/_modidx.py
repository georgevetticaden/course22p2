...
d = { 'settings': { 'branch': 'master',
                'doc_baseurl': '/course22p2s',
                'doc_host': 'https://georgevetticaden.github.io',
                'git_url': 'https://github.com/georgevetticaden/course22p2s',
                'lib_path': 'miniai'},
  'syms': { 'miniai.accel': { 'miniai.accel.AccelerateCB': ('ddpm_v2.html#acceleratecb', 'miniai/accel.py'),
            ...
            'miniai.stability': {},
            'miniai.training': { 'miniai.training.Dataset': ('images/minibatch_training.html#dataset', 'miniai/training.py'),
                                 'miniai.training.Dataset.__getitem__': ( 'images/minibatch_training.html#dataset.__getitem__',
                                                                          'miniai/training.py'),
                                 'miniai.training.Dataset.__init__': ( 'images/minibatch_training.html#dataset.__init__',
                                                                       'miniai/training.py'),
                                 'miniai.training.Dataset.__len__': ( 'images/minibatch_training.html#dataset.__len__',
                                                                      'miniai/training.py'),
                                 'miniai.training.accuracy': ('images/minibatch_training.html#accuracy', 'miniai/training.py'),
                                 'miniai.training.fit': ('images/minibatch_training.html#fit', 'miniai/training.py'),
                                 'miniai.training.get_dls': ('images/minibatch_training.html#get_dls', 'miniai/training.py'),
                                 'miniai.training.report': ('images/minibatch_training.html#report', 'miniai/training.py')}}}
